...
export const addAppNote = data => {
    ...
    return axios.post(`user/${user_id}/job/${job_id}/app_notes`, null, {
        headers: {
            'Authorization': token
        }
    })
...
export const updateAppNote = data => {
    ...
    return axios.patch(`user/${user_id}/job/${job_id}/app_notes/${note_id}`, note_data, {
        headers: {
            'Authorization': token
        }
    })
...
export const deleteAppNote = data => {
    ...
    return axios.delete(`user/${user_id}/job/${job_id}/app_notes/${note_id}`, null, {
        headers: {
            'Authorization': token
        }
    })
